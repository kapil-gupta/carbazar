<footer id="footer" class="container clearfix">
 ...
 @include('frontend/elements/modellogin')

{!! Html::script(static_files_route('js/jquery-1.7.2.min.js')) !!}
{!! Html::script(static_files_route('sliders/flexslider/jquery.flexslider-min.js')) !!}
{!! Html::script(static_files_route('js/jquery-impromptu.js')) !!}
{!! Html::script(static_files_route('js/custom.js')) !!}
</body>

<!-- Mirrored from html.webtemplatemasters.com/car-dealer/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Jan 2016 13:11:32 GMT -->
</html>
